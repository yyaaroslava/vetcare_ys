...
class Species(models.Model):
    ...
    name_uk = models.CharField(max_length=100, verbose_name='Назва (укр)', blank=True)
...
class Animal(models.Model):
    ...
    def __str__(self):
        return f"{self.name} ({self.species.name_uk or self.species.name}) — {self.owner.get_full_name()}"
