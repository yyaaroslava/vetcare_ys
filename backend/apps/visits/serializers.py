...
class VisitSerializer(serializers.ModelSerializer):
    ...
    visit_date = serializers.ReadOnlyField(source='appointment.date')
    visit_time = serializers.TimeField(source='appointment.time', format='%H:%M')
    visit_end_time = serializers.SerializerMethodField()
    status = serializers.ReadOnlyField(source='appointment.status')
